...
.minimalPadding {
  ...
  <input id='srEnabled' type="checkbox"><span class="slider round"></span>
      ...
      <div class='BtnGroup'>
        ${newSRVersion ? `<a class="minimalPadding btn btn-sm BtnGroup-item" id="srUpdate" href='${GM_info.script.downloadURL}' target='_blank' title="Update Speedrun to V${newSRVersion}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="20" height="20" class="octicon octicon-tools color-fg-attention"><path d="M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"></path><path d="M7.25 7.689V2a.75.75 0 0 1 1.5 0v5.689l1.97-1.969a.749.749 0 1 1 1.06 1.06l-3.25 3.25a.749.749 0 0 1-1.06 0L4.22 6.78a.749.749 0 1 1 1.06-1.06l1.97 1.969Z"></path></svg></a>`:''}
  ...
  <details-dialog class="Box height-fit overflow-auto Box-overlay--wide anim-fade-in fast">
    ...
    <div class="Box-footer text-right">
      <button id="srModal-ok" type="button" class="btn btn-primary" autofocus data-close-dialog>Ok</button>
            ...
            dataAndEvents.srUpdate = { events: {'click.sr': async (event) => {
                const srUpdate = $('#srUpdate');
                srUpdate.on('click.sr', (e) => {e.preventDefault();
                                                e.stopPropagation();
                                                location.reload()
                                                return false;
                                               });
