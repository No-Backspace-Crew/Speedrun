...
function setButtonDanger(btn, variables) {
    ...
    if(variables.creds) {
        ...
        btn.attr('aria-label', !hasService ? 'Configure an account in settings to use this' : `${variables.srServiceName}${variables.internal.showPin? " 📌":""}: ${(curRegion||"")} (${variables.role})`);
