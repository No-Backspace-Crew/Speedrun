...
.copyCursor:hover {
  ...
  <summary id="githubIssues" class="btn btn-sm" aria-haspopup="true" title="Recent Github Issues">
...
`).append(`<details id='srModal' class="fixed details-reset details-overlay details-overlay-dark">
  ...
  <details-dialog class="Box height-fit overflow-auto Box-overlay--wide anim-fade-in fast">
    ...
    function isAlwaysOnWikiPath(path) {
        ...
        return path === '/no-backspace-crew/speedrun' || path === '/no-backspace-crew/warp';
    }
