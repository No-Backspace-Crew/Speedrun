...
async function updatePage(reason) {
    ...
    try {
        ...
        for(const block of $("p > code, li > code, td > code, :header > code").not('code + span.copyCursor')) {
