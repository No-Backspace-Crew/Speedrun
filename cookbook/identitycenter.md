...
```
#buildConfig
~~~ssoStartUrl=Identity Center Url {label:"Identity Center Start Url", placeholder:'https://your_subdomain.awsapps.com', pattern:'https:\\/\\/[a-z0-9\\-]+\\.awsapps\\.com(\\/(start(\\/)?))?', default:'${typeof ssoStartUrl === 'undefined' ? '' : ssoStartUrl}'}~~~
```
